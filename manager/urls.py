...
from .views import home_view,AddNoticeView,NoticeHomeView,NoticeEditView,DeleteNoticeView,HideNotice,VerifyStudent,VerifyResume,FinalVerify,SelectedStudentList,AppliedStudentList
